...
/**
 * SpringLayoutTools - provides utility methods for creating form- or grid-style layouts with SpringLayout.
 * These utilities are used by several programs, such as SpringBox and SpringCompactGrid.
 *
 * @author Kontcur Alex (bona)
 * @since 11.07.11
 */
public class SpringLayoutTools {

    private static final Logger logger = LoggerFactory.getLogger(SpringLayoutTools.class);

    private SpringLayoutTools() {
    }
     ...
     *
     * @param parent   component on which to put the grid
